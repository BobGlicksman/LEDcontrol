...
- isPressed():  this method returns a boolean - ture after the button has been pressed and debounced, false otherwise.  This method requires
...
* initializes all objects in setup(), by call their begin() functions in setup().
...
* in loop(), continuously called the isPressed() method on the connected button to refresh its state.  When the button is pressed
